...
SEC_TIPS = re.compile(r"[/.](tips|tips-properti|feng-shui|desain|dekorasi|interior|hunian|inspirasi|inspirasi-properti|panduan|advertorial|sponsored|brandconnect|rumah-idaman|agen-properti)(?=[/.\-?]|$)", re.I)   # 경제 섹션(properti 등)에 얹힌 생활정보·광고성 하위섹션 — 무조건 제외
